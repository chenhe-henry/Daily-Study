...
// which is a subset of favoriteCompanies[0]=["leetcode","google","facebook"] corresponding to the person with index 0.
// Person with index=3 has favoriteCompanies[3]=["google"]
// which is a subset of favoriteCompanies[0]=["leetcode","google","facebook"] and favoriteCompanies[1]=["google","microsoft"].
...
// is a subset of favoriteCompanies[0]=["leetcode","google","facebook"], therefore, the answer is [0,1].
// Example 3:
...
var peopleIndexes = function (favoriteCompanies) {
  ...
  for (let i = 0; i < favoriteCompanies.length; i++) {
    for (let j = 0; j < favoriteCompanies; j++) {
